...
\newcommand{\emailadressen}{patrick.petersen91@gmail.com,}
...
\newcommand{\versuchsnr}{P1-72,74,75}               % bitte die korrekte Nummer dem 
...
%%%%%%%%%%%%%%%%%%                                        \includeodf{./chap/EdurchM-Bestimmung.pdf}
