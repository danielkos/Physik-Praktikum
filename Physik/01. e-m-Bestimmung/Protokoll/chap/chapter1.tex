...
\begin{axis}[
    ...
    axis lines=middle,
     ...
     minor tick num=1,
         xlabel={Messpunkte},
    ylabel={Hallspannung [V]}]
]


\addplot [color=red,only marks] table {
1	0.105
2	0.112
3	0.112
4	0.112
...
\addplot [color=blue,only marks] table {
1	0.16
2	0.165
3	0.165
4	0.165
...
\addplot [color=green,only marks] table {
1	0.2
2	0.21
3	0.215
4	0.215
...
\newline
Sie lässt sich aus den Messwerten (siehe Tabelle \ref{tab:eichspule}) mit linearer Regression (siehe Abbildung \ref{fig:Eichspulengerade}) berechnen und liegt bei $m = 0.146 \frac{s}{m^2}$. Außerdem stimmen die gemessenen Hallspannungen etwa mit den Messungen aus Tabelle \ref{HemholtzspulenpaarUntersuchung} überein.
